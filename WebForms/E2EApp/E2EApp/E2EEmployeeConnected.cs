using E2EApp.Dalayer;
using E2EApp.Entities;
using System;
...
namespace E2EApp
{
    ...
    namespace Dalayer
    {
        ...
        class DataComponent : IDataAccessComponent
        {
            ...
            const string STRINSERT = "InsertEmployee2";
            const string STRUPDATE = "Update tlEmployee Set EmpName = @empName, EmpAddress = @empAddress, EmpSalary = @empSalary WHERE EmpId = @empId";
            const string STRALL = "SELECT * FROM TLEMPLOYEE";
            const string STRALLDEPTS = "SELECT * FROM TLDEPT";
            const string STRDELETE = "DELETE FROM TLEMPLOYEE WHERE EMPID = @id";
            #endregion
